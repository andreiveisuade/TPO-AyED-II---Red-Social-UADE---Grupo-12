...
public class CU_027_ConsultarInfluenciaPorScoring {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU027_TEST.json";
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════╗");
        System.out.println("║  CU-027: CONSULTAR INFLUENCIA");
        System.out.println("╚════════════════════════════════════════════╝\n");
        
        testMain();
        
        System.out.println("\n" + "─".repeat(50));
        System.out.printf("CU-027 RESULTADOS: %d pasados, %d fallados%n", testsPasados, testsFallados);
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 027");
        } catch (Exception e) {
            reportarFallo("Test 027", e.getMessage());
        }
    }
