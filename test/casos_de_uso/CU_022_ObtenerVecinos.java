...
public class CU_022_ObtenerVecinos {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU022_TEST.json";
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════╗");
        System.out.println("║  CU-022: OBTENER VECINOS");
        System.out.println("╚════════════════════════════════════════════╝\n");
        
        testMain();
        
        System.out.println("\n" + "─".repeat(50));
        System.out.printf("CU-022 RESULTADOS: %d pasados, %d fallados%n", testsPasados, testsFallados);
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 022");
        } catch (Exception e) {
            reportarFallo("Test 022", e.getMessage());
        }
    }
