...
public class CU_024_ObtenerSeguidoresEnNivel {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU024_TEST.json";
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════╗");
        System.out.println("║  CU-024: OBTENER SEGUIDORES EN NIVEL");
        System.out.println("╚════════════════════════════════════════════╝\n");
        
        testMain();
        
        System.out.println("\n" + "─".repeat(50));
        System.out.printf("CU-024 RESULTADOS: %d pasados, %d fallados%n", testsPasados, testsFallados);
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 024");
        } catch (Exception e) {
            reportarFallo("Test 024", e.getMessage());
        }
    }
