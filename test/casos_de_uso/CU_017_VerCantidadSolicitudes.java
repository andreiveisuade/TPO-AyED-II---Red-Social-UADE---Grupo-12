...
public class CU_017_VerCantidadSolicitudes {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU017_TEST.json";
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 017");
        } catch (Exception e) {
            reportarFallo("Test 017", e.getMessage());
        }
    }
