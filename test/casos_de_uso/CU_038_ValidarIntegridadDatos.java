...
public class CU_038_ValidarIntegridadDatos {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU038_TEST.json";
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════╗");
        System.out.println("║  CU-038: VALIDAR INTEGRIDAD");
        System.out.println("╚════════════════════════════════════════════╝\n");
        
        testMain();
        
        System.out.println("\n" + "─".repeat(50));
        System.out.printf("CU-038 RESULTADOS: %d pasados, %d fallados%n", testsPasados, testsFallados);
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 038");
        } catch (Exception e) {
            reportarFallo("Test 038", e.getMessage());
        }
    }
