...
public class CU_023_ConstruirArbolRelaciones {
    private static int testsPasados = 0, testsFallados = 0;
    private static final String TEST_DB = "data/clientes_CU023_TEST.json";
    ...
    public static void main(String[] args) {
        System.out.println("\n╔════════════════════════════════════════════╗");
        System.out.println("║  CU-023: CONSTRUIR ARBOL RELACIONES");
        System.out.println("╚════════════════════════════════════════════╝\n");
        
        testMain();
        
        System.out.println("\n" + "─".repeat(50));
        System.out.printf("CU-023 RESULTADOS: %d pasados, %d fallados%n", testsPasados, testsFallados);
    ...
    private static void testMain() {
        try {
            ...
            reportarExito("Test 023");
        } catch (Exception e) {
            reportarFallo("Test 023", e.getMessage());
        }
    }
